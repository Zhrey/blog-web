    ...
    <div class="container">
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
            ...
            <ul class="list-unstyled list-inline">
                <li><a href="http://shang.qq.com/wpa/qunwpa?idkey=9f986e9b33b1de953e1ef9a96cdeec990affd0ac7855e00ff103514de2027b60" target="_blank" title="加入我的QQ交流群：529690676" data-toggle="tooltip" data-placement="bottom" rel="external nofollow"><i class="fa fa-qq"></i>QQ交流群</a></li>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
            ...
            <div style="padding: 4px;padding-left: 10px;">
                ...
                <p style="white-space: initial;">本站作用：写博客、记日志。</p>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
            <h4>问题交流</h4>
            <div class="row" style="padding: 4px;padding-left: 10px;">
                <div class="col-xs-12 col-sm-7 col-md-7" style="white-space: initial;">
                    <span>志同道合者欢迎进QQ交流群(529690676)</span>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5">
                    <a href="${config.staticWebSite}/img/qq_group.png" class="showImage" title="QQ群(529690676)二维码" rel="external nofollow">
                        <img data-original="${config.staticWebSite}/img/qq_group.png" alt="QQ群(529690676)二维码" class="img-responsive img-rounded auto-shake lazy-img" style="width: 100px;">
                    </a>
                </div>
            </div>
        </div>
