<div class="col-sm-3 blog-sidebar">
    ...
    <#else>
        <div class="sidebar-module" style="position: relative;">
            <a href='#' target="_blank" rel="external nofollow"><img src='https://gitee.com/yadong.zhang/DBlog/widgets/widget_1.svg?color=07b83f' alt='Fork me on Gitee' style="position: absolute;right: 0;"/></a>
                ...
                <div id="feed_widget">
                    <div class="feed-about">
                        ...
                        <!--<ul class="list-unstyled">
                            <li><i class="fa fa-info-circle fa-fw"></i>博主：<small>张睿</small></li>
